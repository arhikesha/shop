...
include ("include/functions.php");
 ...
 switch($sort){
	 ...
	 break;
	  ...
	  case 'confimed':
	 $sort = "order_confimed='yes' DESC";
	 $sort_name = 'Обработаные';
		break;
	 
	  case 'no-confimed':
	 $sort = "order_confimed='no' DESC";
...
<?php
	...
	$buy_count = mysqli_query($link,"SELECT * FROM orders WHERE order_confimed ='yes'");
	$buy_count_result = mysqli_num_rows($buy_count);
	
	$no_buy_count = mysqli_query($link,"SELECT * FROM orders WHERE order_confimed ='no'");
...
?>
	<div id ="block-content">
		...
		<li><a href="orders.php?sort=confimed">Обработаные</a></li>
		<li><a href="orders.php?sort=no-confimed">Не обработаные</a></li>
		</ul>
	</li>
	</ul>
		...
		<ul id ="review-info-count">
			...
			<li>Обработаные - <strong><? echo $buy_count_result;?></strong></li>
			<li>Не обработаные - <strong><? echo $no_buy_count_result;?></strong></li>
		</ul>
		</div>
<?php
